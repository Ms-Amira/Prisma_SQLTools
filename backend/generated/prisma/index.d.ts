...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "adopter" | "pet" | "shelter"
  ...
  export type AdopterCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    pets?: boolean | AdopterCountOutputTypeCountPetsArgs
  }
   ...
   * AdopterCountOutputType without action
   */
  export type AdopterCountOutputTypeCountPetsArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    where?: PetWhereInput
  }
  ...
  export type AdopterSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    approval?: boolean
    pets?: boolean | Adopter$petsArgs<ExtArgs>
  ...
  export type AdopterOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "phoneNumber" | "animalsInHome" | "approval", ExtArgs["result"]["adopter"]>
  ...
  export interface Prisma__AdopterClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    pets<T extends Adopter$petsArgs<ExtArgs> = {}>(args?: Subset<T, Adopter$petsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$PetPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  interface AdopterFieldRefs {
    ...
    readonly phoneNumber: FieldRef<"Adopter", 'String'>
    readonly animalsInHome: FieldRef<"Adopter", 'Int'>
    readonly approval: FieldRef<"Adopter", 'ApprovalStatus'>
  }
   ...
   * Adopter.pets
   */
  export type Adopter$petsArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type PetOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "species" | "breed" | "age" | "medicalHistory" | "adopterId" | "shelterId", ExtArgs["result"]["pet"]>
  ...
  export interface Prisma__PetClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    adopter<T extends Pet$adopterArgs<ExtArgs> = {}>(args?: Subset<T, Pet$adopterArgs<ExtArgs>>): Prisma__AdopterClient<$Result.GetResult<Prisma.$AdopterPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
  ...
  export type ShelterOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "address" | "phoneNumber" | "capacity" | "website", ExtArgs["result"]["shelter"]>
  ...
  interface ShelterFieldRefs {
    ...
    readonly phoneNumber: FieldRef<"Shelter", 'String'>
  ...
  export type AdopterWhereInput = {
    ...
    phoneNumber?: StringFilter<"Adopter"> | string
    animalsInHome?: IntFilter<"Adopter"> | number
    approval?: EnumApprovalStatusFilter<"Adopter"> | $Enums.ApprovalStatus
  ...
  export type AdopterScalarWhereWithAggregatesInput = {
    ...
    phoneNumber?: StringWithAggregatesFilter<"Adopter"> | string
    animalsInHome?: IntWithAggregatesFilter<"Adopter"> | number
    approval?: EnumApprovalStatusWithAggregatesFilter<"Adopter"> | $Enums.ApprovalStatus
  }
  ...
  export type ShelterWhereInput = {
    ...
    phoneNumber?: StringFilter<"Shelter"> | string
    capacity?: IntFilter<"Shelter"> | number
    website?: StringFilter<"Shelter"> | string
    pets?: PetListRelationFilter
  }
  ...
  export type ShelterScalarWhereWithAggregatesInput = {
    ...
    phoneNumber?: StringWithAggregatesFilter<"Shelter"> | string
    capacity?: IntWithAggregatesFilter<"Shelter"> | number
    website?: StringWithAggregatesFilter<"Shelter"> | string
  }
  ...
  export type AdopterCreateInput = {
    ...
    animalsInHome: number
    approval: $Enums.ApprovalStatus
    pets?: PetCreateNestedManyWithoutAdopterInput
  }
  ...
  export type AdopterUncheckedCreateInput = {
    ...
    animalsInHome: number
    approval: $Enums.ApprovalStatus
    pets?: PetUncheckedCreateNestedManyWithoutAdopterInput
  }
  ...
  export type AdopterUpdateInput = {
    ...
    animalsInHome?: IntFieldUpdateOperationsInput | number
    approval?: EnumApprovalStatusFieldUpdateOperationsInput | $Enums.ApprovalStatus
    pets?: PetUpdateManyWithoutAdopterNestedInput
  }
  ...
  export type AdopterUncheckedUpdateInput = {
    ...
    animalsInHome?: IntFieldUpdateOperationsInput | number
    approval?: EnumApprovalStatusFieldUpdateOperationsInput | $Enums.ApprovalStatus
    pets?: PetUncheckedUpdateManyWithoutAdopterNestedInput
  }
  ...
  export type PetCreateInput = {
    ...
    age: number
    medicalHistory: string
    adopter?: AdopterCreateNestedOneWithoutPetsInput
  ...
  export type PetUpdateInput = {
    ...
    adopter?: AdopterUpdateOneWithoutPetsNestedInput
  ...
  export type AdopterCreateNestedOneWithoutPetsInput = {
    create?: XOR<AdopterCreateWithoutPetsInput, AdopterUncheckedCreateWithoutPetsInput>
    connectOrCreate?: AdopterCreateOrConnectWithoutPetsInput
  ...
  export type AdopterUpdateOneWithoutPetsNestedInput = {
    create?: XOR<AdopterCreateWithoutPetsInput, AdopterUncheckedCreateWithoutPetsInput>
    connectOrCreate?: AdopterCreateOrConnectWithoutPetsInput
    upsert?: AdopterUpsertWithoutPetsInput
    disconnect?: AdopterWhereInput | boolean
    delete?: AdopterWhereInput | boolean
    connect?: AdopterWhereUniqueInput
    update?: XOR<XOR<AdopterUpdateToOneWithWhereWithoutPetsInput, AdopterUpdateWithoutPetsInput>, AdopterUncheckedUpdateWithoutPetsInput>
  }
  ...
  export type AdopterCreateWithoutPetsInput = {
    name: string
    email: string
    phoneNumber: string
    animalsInHome: number
  ...
  export type AdopterUncheckedCreateWithoutPetsInput = {
    id?: number
    name: string
    email: string
    phoneNumber: string
  ...
  export type AdopterCreateOrConnectWithoutPetsInput = {
    where: AdopterWhereUniqueInput
    create: XOR<AdopterCreateWithoutPetsInput, AdopterUncheckedCreateWithoutPetsInput>
  }
  ...
  export type AdopterUpsertWithoutPetsInput = {
    update: XOR<AdopterUpdateWithoutPetsInput, AdopterUncheckedUpdateWithoutPetsInput>
    create: XOR<AdopterCreateWithoutPetsInput, AdopterUncheckedCreateWithoutPetsInput>
    where?: AdopterWhereInput
  }

  export type AdopterUpdateToOneWithWhereWithoutPetsInput = {
    where?: AdopterWhereInput
    data: XOR<AdopterUpdateWithoutPetsInput, AdopterUncheckedUpdateWithoutPetsInput>
  }

  export type AdopterUpdateWithoutPetsInput = {
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    phoneNumber?: StringFieldUpdateOperationsInput | string
    animalsInHome?: IntFieldUpdateOperationsInput | number
  ...
  export type AdopterUncheckedUpdateWithoutPetsInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    phoneNumber?: StringFieldUpdateOperationsInput | string
